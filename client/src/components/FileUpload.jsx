          ...
          >
            ...
            {selectedFiles.length > 0 ? (
              ...
              <div className="flex flex-col items-center justify-center py-10 px-4 text-center">
                ...
                <p className="text-xs text-slate-400 mt-1">DOCX & PDF · Max ~800 paragraphs per file (roughly 30-40 pages). Larger files should use the CLI tool for reliable 97%+ accuracy.</p>
              </div>
            )}
          </div>
